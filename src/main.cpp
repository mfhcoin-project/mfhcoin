...
#if defined(NDEBUG)
# error "Mfhcoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Mfhcoin Signed Message:\n";
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Mfhcoin: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // Mfhcoin: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
