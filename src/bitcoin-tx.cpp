...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Mfhcoin Core mfhcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  mfhcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mfhcoin transaction") + "\n" +
              "  mfhcoin-tx [options] -create [commands]   " + _("Create hex-encoded mfhcoin transaction") + "\n" +
              "\n";
